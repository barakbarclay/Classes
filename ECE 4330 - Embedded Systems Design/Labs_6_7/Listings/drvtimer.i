...
#line 56 "..\\CoreSupport\\core_cm0.h"
...
#line 82 "..\\CoreSupport\\core_cm0.h"
...
#line 377 "..\\CoreSupport\\core_cm0.h"
...
#line 395 "..\\CoreSupport\\core_cm0.h"
...
#line 500 "..\\CoreSupport\\core_cm0.h"
...
#line 770 "..\\CoreSupport\\core_cm0.h"
...
#line 75 "..\\Include\\NUC1xx.h"
#line 1 "..\\NUC1xx\\system_NUC1xx.h"
...
#line 6782 "..\\Include\\NUC1xx.h"

#line 6789 "..\\Include\\NUC1xx.h"
...
static uint32_t GetTimerClock(E_TIMER_CHANNEL ch)
{
    ...
    {
        u8ClockSrc = ((*((volatile unsigned int *)(&((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL1))) >> (8+(ch*4))) & 0x7;
...
{    
    ...
    if ((((TIMER_T *) ((( uint32_t)0x40000000) + 0x10020))->TEXCON.TEXEN == 1) && (((TIMER_T *) ((( uint32_t)0x40000000) + 0x10020))->TEXCON.TEXIEN == 1) && (((TIMER_T *) ((( uint32_t)0x40000000) + 0x10020))->TEXISR.TEXIF == 1))
        ((TIMER_T *) ((( uint32_t)0x40000000) + 0x10020))->TEXISR.TEXIF = 1;
...
{    
    if ((((TIMER_T *) ((( uint32_t)0x40100000) + 0x10000))->TCSR.IE == 1) && (((TIMER_T *) ((( uint32_t)0x40100000) + 0x10000))->TISR.TIF == 1))
        ((TIMER_T *) ((( uint32_t)0x40100000) + 0x10000))->TISR.TIF = 1;

    if ((((TIMER_T *) ((( uint32_t)0x40100000) + 0x10000))->TEXCON.TEXEN == 1) && (((TIMER_T *) ((( uint32_t)0x40100000) + 0x10000))->TEXCON.TEXIEN == 1) && (((TIMER_T *) ((( uint32_t)0x40100000) + 0x10000))->TEXISR.TEXIF == 1))
        ((TIMER_T *) ((( uint32_t)0x40100000) + 0x10000))->TEXISR.TEXIF = 1;
...
void TMR3_IRQHandler(void)
{
    ...
    if ((((TIMER_T *) ((( uint32_t)0x40100000) + 0x10020))->TEXCON.TEXEN == 1) && (((TIMER_T *) ((( uint32_t)0x40100000) + 0x10020))->TEXCON.TEXIEN == 1) && (((TIMER_T *) ((( uint32_t)0x40100000) + 0x10020))->TEXISR.TEXIF == 1))
        ((TIMER_T *) ((( uint32_t)0x40100000) + 0x10020))->TEXISR.TEXIF = 1;
...
int32_t DrvTIMER_EnableInt(E_TIMER_CHANNEL ch)
{
   	...
   	switch (ch)
    {
		...
		case E_TMR3:
        {
        	tTMR = (TIMER_T *)((uint32_t)((TIMER_T *) ((( uint32_t)0x40000000) + 0x10000)) + CH_OFFSET[ch]);         
            tTMR->TCSR.IE = 1;
            NVIC_SetPriority((IRQn_Type)((uint32_t)TMR0_IRQn + (uint32_t)ch), (1<<2) - 2);
...
{
	if (ch == E_TMR0 )
		return ((TIMER_T *) ((( uint32_t)0x40000000) + 0x10000))->TISR.TIF;
	else if(ch == E_TMR1 )									 
		return ((TIMER_T *) ((( uint32_t)0x40000000) + 0x10020))->TISR.TIF;
	else if(ch == E_TMR2 )
		return ((TIMER_T *) ((( uint32_t)0x40100000) + 0x10000))->TISR.TIF;
	else if(ch == E_TMR3 )
		return ((TIMER_T *) ((( uint32_t)0x40100000) + 0x10020))->TISR.TIF;
	else 
    	return (((1) ? 0xFFFF0000 : 0x00000000) | ((((MODULE_ID_DRVTIMER) & 0xFF) | ((1) ? 0x100 : 0x00)) << 7) | ((1) & 0x7F));
}
...
int32_t DrvTIMER_CloseCapture(E_TIMER_CHANNEL ch)
{
   	...
   	switch (ch)
    {
        ...
        {
        	tTMR = (TIMER_T *)((uint32_t)((TIMER_T *) ((( uint32_t)0x40000000) + 0x10000)) + CH_OFFSET[ch]);         
			*((volatile unsigned int *)((uint32_t)&tTMR->TEXCON))=0;	
            return 0;
        }
...
void WDT_IRQHandler(void)
{
    ...
    uWakeupFlag = ((WDT_T *) ((( uint32_t)0x40000000) + 0x4000))->WTCR.WTWKF;   
...
int32_t DrvWDT_Open(E_WDT_INTERVAL WDTlevel)
{
	if ((((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->REGWRPROT & 0x01) == 0)
    {
         
        return (((1) ? 0xFFFF0000 : 0x00000000) | ((((MODULE_ID_DRVTIMER) & 0xFF) | ((1) ? 0x100 : 0x00)) << 7) | ((6) & 0x7F));
    }
...
int32_t DrvWDT_Ioctl(E_WDT_CMD uWDTCmd, uint32_t uArgument)
{
    switch (uWDTCmd)
    {
        ...
        {
            ((WDT_T *) ((( uint32_t)0x40000000) + 0x4000))->WTCR.WTIE = 1;
            NVIC_SetPriority(WDT_IRQn, (1<<2) - 2);
