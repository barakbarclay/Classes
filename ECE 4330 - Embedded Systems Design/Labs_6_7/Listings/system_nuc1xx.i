...
#line 6782 "..\\NUC1xx\\NUC1xx.h"

#line 6789 "..\\NUC1xx\\NUC1xx.h"
...
#line 6835 "..\\NUC1xx\\NUC1xx.h"


                                                                                                 
#line 8 "..\\NUC1xx\\system_NUC1xx.c"
...
uint32_t gau32ClkSrcTbl[] = {(12000000UL), (32768UL), ((22118400UL)), (10000UL), (22118400UL)};
...
void SystemCoreClockUpdate (void)             
{
    ...
    u32ClkSrc = ((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL0.HCLK_S;
    ...
    else
    {
        ...
        u32Shift = ((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->PLLCON.OUT_DV;    
        if(u32Shift > 1) u32Shift--;
        u32CoreFreq = ((((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->PLLCON.PLL_SRC)?(22118400UL):(12000000UL)) * (((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->PLLCON.FB_DV+2) / (((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->PLLCON.IN_DV+2) >> u32Shift;
    }
 
    SystemCoreClock = (u32CoreFreq/(((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKDIV.HCLK_N + 1));
